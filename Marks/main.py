...
main_1a = pd.read_excel(io=file1, sheet_name=sheet1, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_1b = pd.read_excel(io=file1, sheet_name=sheet2, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_1c = pd.read_excel(io=file1, sheet_name=sheet3, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_1d = pd.read_excel(io=file1, sheet_name=sheet4, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_1e = pd.read_excel(io=file1, sheet_name=sheet5, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_1f = pd.read_excel(io=file1, sheet_name=sheet6, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
...
main_2a = pd.read_excel(io=file2, sheet_name=sheet1, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_2b = pd.read_excel(io=file2, sheet_name=sheet2, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_2c = pd.read_excel(io=file2, sheet_name=sheet3, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_2d = pd.read_excel(io=file2, sheet_name=sheet4, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_2e = pd.read_excel(io=file2, sheet_name=sheet5, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_2f = pd.read_excel(io=file2, sheet_name=sheet6, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
...
main_3a = pd.read_excel(io=file3, sheet_name=sheet1, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_3b = pd.read_excel(io=file3, sheet_name=sheet2, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_3c = pd.read_excel(io=file3, sheet_name=sheet3, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_3d = pd.read_excel(io=file3, sheet_name=sheet4, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_3e = pd.read_excel(io=file3, sheet_name=sheet5, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_3f = pd.read_excel(io=file3, sheet_name=sheet6, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
...
main_4a = pd.read_excel(io=file4, sheet_name=sheet1, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_4b = pd.read_excel(io=file4, sheet_name=sheet2, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_4c = pd.read_excel(io=file4, sheet_name=sheet3, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_4d = pd.read_excel(io=file4, sheet_name=sheet4, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_4e = pd.read_excel(io=file4, sheet_name=sheet5, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
main_4f = pd.read_excel(io=file4, sheet_name=sheet6, usecols=usecols, names=usenames, converters={"Cell": str, "Adm": str})
